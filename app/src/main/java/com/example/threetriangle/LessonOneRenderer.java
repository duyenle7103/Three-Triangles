package com.example.threetriangle;
...
public class LessonOneRenderer implements GLSurfaceView.Renderer
{
    ...
    public LessonOneRenderer()
    {
        ...
        logVertexBuffer("Triangle 1", mTriangle1Vertices);
        logVertexBuffer("Triangle 2", mTriangle2Vertices);
        logVertexBuffer("Triangle 3", mTriangle3Vertices);
    }
